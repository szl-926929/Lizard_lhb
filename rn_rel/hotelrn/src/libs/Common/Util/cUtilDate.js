...
class cUtilDate {
    ...
    if (typeof str === 'string') {
        ...
        return isNative ? t : new cUtilDate(t);
...
//    return new cUtilDate(obj).format(str);
//},
    /**
     *  获取周几，d为日期C.parse(d);
     *  @static
