  ...
  */
  ...
  var url = arguments[0], html = arguments[1], fetchedDatas = arguments[2],funcStr;
    ...
    {     
      ...
      if (pdInitScript)
      {
        return JSON.stringify({bProceed: true, models: [{url: pdInitScript._attrs['src'], postdata: '', name: '100'}], fetchedDatas: arguments[2]});   
      }
      else
      {
        fetchedDatas = {100: ''};
    ...
    return JSON.stringify({bProceed: (leftmodels.length != 0), models: leftmodels, fetchedDatas: arguments[2]});   
  };
