...
'"> <div id="icon_text" class="txt_middle"><img src="https://res.m.ctrip.com/html5/content/images/icon_text_s6_1.png"/></div>',
' <a href="' + url + '" id="app_link" class="txt_middle __appaddress__"><img src="https://res.m.ctrip.com/html5/content/images/icon_open_s6.png"/></a>',
...
adOptions.appDownload = function () {
  ...
  if (isMac) {
    ...
    AppUtility.openApp(function () {
      ...
      var url = "https://m.ctrip.com/market/download.aspx?from=H5";
      if (s) {
        if (s.appurl && s.appurl.length > 0)
          url = s.appurl;
        else if (s.sid && +s.sid > 0) {
          url = "https://m.ctrip.com/market/download.aspx?from=" + s.sid;
        }
      }
...
isopen_iosapp = 0;
  ...
  if (isMac) {
    ...
    AppUtility.openApp(function () {
      ...
      var url = "https://m.ctrip.com/market/download.aspx?from=" + sourceid;
      //设置下载Android客户端 url
      if (isAndroid) {
