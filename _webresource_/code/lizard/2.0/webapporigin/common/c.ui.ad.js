...
adOptions.createHtml = function () {
    ...
    '"> <div id="icon_text" class="txt_middle"><img src="https://res.m.ctrip.com/html5/content/images/icon_text_s6.png"/></div>',
...
adOptions.checkForceDownload = function (sourceid) {
    ...
    AppUtility.openApp(function () {
        ...
        //Android强制下载
        if (isAndroid) {
            var url = "https://m.ctrip.com/market/download.aspx?from=" + sourceid + '&App=3';
