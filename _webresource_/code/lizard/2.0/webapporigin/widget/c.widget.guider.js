...
*
*/
define(['cUtilityHybrid', 'cWidgetFactory', 'cHybridFacade', 'cHybridShell','cUtilityPath'], function (Util, WidgetFactory, Facade, Hish,Path) {
  "use strict";
  ...
  WidgetFactory.register({
    name: WIDGET_NAME,
    fn: (Util.isInApp() && !Lizard.app.code.is('GS')) ? HybridGuider : Guider
  });
});
