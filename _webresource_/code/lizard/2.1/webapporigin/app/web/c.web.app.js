define(['cUtilCommon', 'cCoreInherit', 'cAbstractApp', 'cUtilPath', 'cAjax'], function (UtilCommon, cCoreInherit, APP, Path, cAjax) { 
  return cCoreInherit.Class(APP, {
    ...
    _loadViewByLocationUrl: function()
    {
      ...
      this.__startState = {url: landingpath, text: document.documentElement.innerHTML, options: {pushState: false, renderAt: Lizard.renderAt, landingpage: 1, hideloading: Lizard.config.isFirstPageHideLoading}};
    ...
    _loadViewByOptions: function(url, html, opt)
    {
      ...
      if (html.indexOf('lizard.seed.js') == -1) {
