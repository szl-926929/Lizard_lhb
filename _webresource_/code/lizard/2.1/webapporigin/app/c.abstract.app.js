 ...
 * @version V2.1
 */
define(['cPageModelProcessor', 'cUtilPerformance', 'cUtilCommon', (Lizard.config.plainloading?'UILoadingLayer':'loading'), ((Lizard.app.vendor.is('CTRIP') || Lizard.isHybrid) && !Lizard.app.code.is('WE')) ? 'cHybridHeader' : 'UIHeader', (Lizard.config.plainloading?'UIWarning404':'loadFailed'), 'UIAlert', 'UIToast', 'cMessageCenter', 'UIAnimation', Lizard.app.version.gte(6.4)? 'cHybridShell' : '','cPageParser'],
    ...
    APP.prototype = {
      ...
      loadView: function (url, html, options) {
        ...
        callModels(pageConfig, _.bind(function (datas, pageConfig) {
          ...
          //执行渲染
          var renderObj = Lizard.render(pageConfig, datas, options.renderAt);
