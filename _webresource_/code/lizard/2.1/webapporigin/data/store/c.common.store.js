 ...
 */
define(['cCoreInherit', 'cUserStore', 'cHeadStore','cAuthStore', 'cMarketStore','cMobileTokenStore'], function (cCoreInherit, cUserStore, cHeadStore,cAuthStore, cMarketStore,cMobileTokenStore) {
  var Common = {};
