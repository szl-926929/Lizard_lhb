 ...
 * @version V1.0
 */
define(['libs', 'cCoreInherit', 'cAjax', 'cUtilCommon', 'cUtilPath','cMessageCenter'], function (libs, cCoreInherit, cAjax, cUtilCommon, pathUtil,MessageCenter) {
/**
    ...
    _execute: function (onComplete, onError, scope, onAbort, params) {
      ...
      var __onComplete = $.proxy(function (data) {
        ...
        function verificationCode(){
          //此处需要添加弹出验证码的框
          MessageCenter.subscribe('verificationCode', $.proxy(function(){
