define(function () {  
  ...
  require.config({
    ...
    "paths"    : {
      ...
      // 情感化loading
      'UILoading'     : Lizard.dir + (Lizard.uibeta_sandbox?"ui_beta":"ui") + '/ui.loading',
      ...
      'UICalendarCommon': Lizard.dir + (Lizard.uibeta_sandbox ? "ui_beta" : "ui") + '/ui.calendar.common',
      ...
      // 针对图片浏览器埋点
      'UIUbtPB'      : Lizard.dir + (Lizard.uibeta_sandbox?"ui_beta":"ui") + '/ui.ubt.pb',
      // 手指缩放
      'UIPinchZoom': Lizard.dir + (Lizard.uibeta_sandbox?"ui_beta":"ui") + '/ui.pinch.zoom',
      // 上传图片
