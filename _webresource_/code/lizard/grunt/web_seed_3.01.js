...
(function(){
  ...
  var comboModules = isDebug ? [ "/code/lizard/3.01/web/lizard.parser.src.js"]: [ "/code/lizard/3.01/web/lizard.parser.js"];
  var lizardConfig;
  var lizardSeedUrl;
  var cruPath = "";
  var env = isH5();
  ...
  if(env.isInCtrip){    
    //if(env.isNeedWeb){
    //  comboModules.push(!isDebug?"/code/lizard/3.01/web/lizard.web.src.js":"/code/lizard/3.01/web/lizard.web.js");
    //}  
    if (env.ctripUA === 'AndroidTV_CtripWireless') {
      comboModules.push("/code/lizard/3.01/web/app/c.tv.start.js"); 
    } else if (env.ctripUA === 'Tieyou_TieyouWireless') {
      comboModules.push("/code/lizard/3.01/web/app/c.ty.start.js");   
    } else {
      comboModules.push(isDebug?"/code/lizard/3.01/web/lizard.hybrid.src.js":"/code/lizard/3.01/web/lizard.hybrid.js");
    }
  }
