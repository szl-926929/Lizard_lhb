/*!
 * @description: CtripHybrid v0.1.0 -javascript library for ctrip hybrid
 * @created: 2016-06-01 11:06:47
 * @author: jimzhao
 */
  // <script type="text/javascript" src="ctrip_internal.js"></script>
...
var CtripBar = {
     ...
     * @example
        ...
        //导航栏总共分为3部分:
        1.左侧，V6.4开始，支持设置左侧按钮，可以是一个图片按钮，或者一个文字按钮;不设置左侧按钮的时候，默认使用app的返回按钮 
            left:[
                {
                    "tagname":"my_custom_back", //tagname，有默认值，为back，参考下面默认tagname的说明
                    "value":"返回到团购", //有imagePath，且imagePath对应的图片存在的时候，value的文字不显示
                    "imagePath":"car/res/logo.png", //左侧按钮图标，图标优先于左侧按钮文字value显示
                    "pressedImagePath":"car/res/logo.png"  //左侧按钮图标选中的图片
                }
            ]
        ...
        3.右侧按钮,key=right, 可以自定义，样式总共3种， 
            ...
            right:[{
                ...
                httpImageUrl:"http://10.2.57.11/hapi/qunit/imgs/icon_clock.png" //远程加载图标，imagePath 字段不传才会使用这个字段。
                badgeNumber:1 //右侧按钮，数字角标V6.4开始支持，不设置或者为0的时候，badgeNumber不显示，最多支持到99
            }]
            ...
            moreMenus:[
                {
                    ...
                    imagePath:"car/res/logo.png",  //按钮上的图片，可以是相对于业务模块的路径，比如 car/res/logo.png， v5.8开始支持
                    pressedImagePath:"car/res/logo.png", //按钮上的图片选中的效果图，可以是相对于业务模块的路径，比如 car/res/logo.png， v5.8开始支持
                    badgeNumber:7 //更多菜单按钮，数字角标V6.4开始支持，不设置或者为0的时候，badgeNumber不显示，最多支持到99
                    httpImageUrl:"http://10.2.57.11/hapi/qunit/imgs/icon_clock.png" //远程加载图标，imagePath 字段不传才会使用这个字段。
                }
        ...
        5. 顶部2个按钮<Segment>配置,key=centerSegments
          centerSegments:[
            {
              tagname:"left_title",
              value:"左侧按钮"
        ...
        6.  app预置tagname定义及说明(hybrid开发人员请避免使用以下预置的tagname),带"_text" 后缀会显示带文字的按钮，回调事件名不带"_text"：
            1). tagname=home/home_text, 返回app首页，图片，事件 都不需要H5处理；
            2). tagname=call/call_text, 拨打呼叫中心，图片，事件 都不需要H5处理；                 @电话CTI统一出口，6.1开始，当前tagname需要，json对象中需要配置businessCode， pageId字段
            3). tagname=phone/phone_text, 拨打电话，图片-native预置，事件交由H5处理；v5.8开始支持； 
            4). tagname=share/share_text, 分享，图片-native预置，事件将会交给H5处理；v5.8开始支持；
            5). tagname=favorite/favorite_text, 收藏，图片-native预置, 事件交给H5处理；v5.8开始支持；
            6). tagname=favorited/favorited_text, 已经收藏，图片-native预置，事件交给H5处理；v5.8开始支持；
            7). tagname=more/more_text, 图片，事件 都不需要H5处理；
           ...
           16). tagname="back", 左侧按钮-返回，图片native预置，事件交由H5处理，和不能设置左侧按钮的时候一致；V6.4开始
           17). 其他tagname，图片有H5提供，事件H5处理；
           18). tagname="city_location",城市定位
    ...
    app_set_navbar_hidden:function(isHidden) {
        ...
        Internal.callNative("NavBar","setNavBarHidden",params,"set_navbar_hidden");
    },
    ...
    app_set_toolbar_hidden:function(isHidden) {
        ...
        var params = {};
        params.isHidden = isHidden;
        Internal.callNative("NavBar","setToolBarHidden",params,"set_toolbar_hidden");
    }
};
...
function __read_platform_info() {
    ...
    if (ua.indexOf("_CtripWireless") > 0) {
...
var CtripBusiness = {
    ...
    app_choose_invoice_title:function(selectedInvoiceTitle) {
        ...
        Internal.callNative("Business", "chooseInvoiceTitle", params, 'choose_invoice_title');
    },
    ...
    app_show_voice_search:function(businessType) {
        ...
        Internal.callNative("Business", "showVoiceSearch", params, 'show_voice_search');
    },
    ...
    app_open_adv_page:function(advUrl) {
        ...
        Internal.callNative("Util", "openAdvPage", params, "open_adv_page");
    },
    ...
    app_log_event:function(event_name) {
        if (Internal.isNotEmptyString(event_name)) {
            ...
            Internal.callNative("Util", "logEvent", params, "log_event");
        }
    },
    ...
    app_get_device_info:function() {
        ...
        Internal.callNative("Business", "getDeviceInfo", null, "get_device_info");
    },
     ...
     * @param {String} pattern 匹配的正则表达式, 可选，不传则使用默认的正则匹配(登录注册使用)，V6.5开始支持。
     ...
     * @example 
        ...
        app.callback(json_obj);
     */
    app_read_verification_code_from_sms:function(pattern) {
        ...
        Internal.callNative("Business", "readVerificationCodeFromSMS", params, "read_verification_code_from_sms");
    },

     /**
     * @description 记录google remarkting的screenName
     * @brief 记录google remarkting的screenName
     * @param {String} screenName 需要纪录的页面名，6.13开始对应 pageId
     * @param {JSON} userInfo 埋点附加信息，@since v6.13,
     ...
     */
    app_log_google_remarkting:function(screenName, userInfo) {
        if (!Internal.isSupportAPIWithVersion("5.8")) {
            return;
        }
        if (!screenName) {
        ...
        Internal.callNative("Business", "logGoogleRemarking", params, "log_google_remarkting");
    },
    ...
    app_choose_contact_from_addressbook:function() {
        ...
        Internal.callNative("Business", "chooseContactFromAddressbook", null, "choose_contact_from_addressbook");
    },
    ...
    app_send_ubt_log:function(tags) {
        ...
        Internal.callNative("Business", "sendUBTLog", params, "send_ubt_log");
    },
    ...
    app_send_ubt_trace:function(traceName, tags) {
        ...
        Internal.callNative("Business", "sendUBTTrace", params, "send_ubt_trace");
    },
    ...
    app_send_ubt_metrics:function(metricsName, numValue, tags) {
        ...
        Internal.callNative("Business", "sendUBTMetrics", params, "send_ubt_metrics");
    },

    /**
     * @description 使用native统计UBT event日志
     * @brief 使用native统计UBT event日志
     * @method app_send_ubt_event
     * @param {String} code 需要记录code名
     * @param {JSON} userInfo 埋点附加信息，会传到UBT server，由BI分析
     ...
     * 
        //调用API
        CtripBusiness.app_send_ubt_event('log_log_code', {pageId:'xxxx',a:'bbb'});
     */
    app_send_ubt_event:function(code, userInfo) {
        ...
        Internal.callNative("Business", "sendUBTEvent", params, "send_ubt_event");
    },
    ...
    app_do_business_job:function(businessType, businessCode, jsonParam, sequenceId) {
        ...
        Internal.callNative("Business", "doBusinessJob", params, "do_business_job");
    },
    ...
    */
    app_get_channel_info:function() {
        ...
        Internal.callNative("Business", "getChannelInfo", null, "get_channel_info");
    },
    ...
    */
    app_get_abtesting_info:function(expCode, statisticsMeta) {
        ...
        Internal.callNative("Business", "getABTestingInfo", params, "get_abtesting_info");
    },


    /**
     * @description 调用身份证输入控件
     * @brief  调用身份证输入控件
     * @method app_input_identify_card_number
     * @callback input_identify_card_number
     * @author jimzhao
     * @since v6.7
     * @example
     *
     * 
        //调用API
        CtripBusiness.app_input_identify_card_number();

        //回调数据
        var json_obj = {
            tagname:"input_identify_card_number",
            param:{
                input:"42108819881212111X"
            }
         };
    */
    app_input_identify_card_number:function() {
     ...
     /**
     * @description native UBT 记录 JS UBT<框架UBT team使用>
     * @brief native UBT 记录 JS UBT<框架UBT team使用>
     * @method app_track_UBT_JS_log
     * @param {String} code 需要纪录的trace名
     * @param {JSON} tags 页面带的配置信息，可自定义，会传到UBT server，由BI分析
     * @author jimzhao
     * @since v6.10
     * @example
     ...
     * 
        //调用API
        CtripBusiness.app_track_UBT_JS_log('code_name_here', {pageId:'xxxx',a:'bbb'});

     */
    app_track_UBT_JS_log:function(code, tags) {
        ...
        Internal.callNative("Business", "trackUBTJSLog", params, "track_UBT_JS_log");
    },
...
var CtripCalendar = {
	/**
     * @brief 添加日历事件
     * @description  native 添加日历事件
     * @param {JSON} event 日历事件
     * event 支持的字段：

     * title:日历事件的 title {String}<br/>
     * desc:日历事件的描述 {String}<br/>
     * location:日历事件的 location 字段 {String}<br/>
     * start:事件开始时间戳 {String}<br/>
     * end:事件结束时间戳 {String}<br/>
     * hasAlarm:是否响铃 {Boolean}<br/>
     * remindMinutes:重复提醒时间间隔 {String}<br/>
     
     * @method app_add_calendar_event
     * @since v6.10
     * @example
        var event = {
            title:'测试添加日历事件',
        ...
        CtripCalendar.app_add_calendar_event(event)";
     *
     ...
     //(-204)系统接口返回失败
        ...
        var json_obj =
        {
            tagname:"add_calendar_event",
            error_code:"error",
        }

        app.callback(json_obj);
     */
    app_add_calendar_event:function(event) {
        if (event == null) {
            event = {};
        };
        var params = {'event':event};

        Internal.callNative("Calendar", "addCalendarEvent", params, "add_calendar_event");
    }
};
 ...
 */
 var CtripEncrypt = {
    ...
    app_base64_encode:function(toIncodeString) {
        ...
        Internal.callNative("Encrypt", "base64Encode", params, 'base64_encode');
    },
    ...
    app_md5_hash:function(inString) {
        ...
        Internal.callNative("Encrypt", "md5Hash", params, 'md5_hash');
    },
    ...
    app_ctrip_encrypt:function(inString, encType) {
        ...
        Internal.callNative("Encrypt", "ctripEncrypt", params, 'ctrip_encrypt');
    }
...
var CtripFile  = {
    ...
    app_get_current_sandbox_name:function() {
        ...
        Internal.callNative("File", "getCurrentSandboxName", params, 'get_current_sandbox_name');
    },
    ...
    app_write_text_to_file:function(text, fileName, relativeFilePath, isAppend) {
        ...
        Internal.callNative("File", "writeTextToFile", params, 'write_text_to_file');
    },
    ...
    app_delete_file:function(fileName, relativeFilePath) {
        ...
        params.relativeFilePath = relativeFilePath;
        params.pageUrl = window.location.href;
        Internal.callNative("File", "deleteFile", params, 'delete_file');
    },
    ...
    app_read_text_from_file:function(fileName, relativeFilePath) {
        ...
        params.pageUrl = window.location.href;
        params.relativeFilePath = relativeFilePath;
        Internal.callNative("File", "readTextFromFile", params, 'read_text_from_file');
    },
    ...
    app_get_file_size:function(fileName, relativeFilePath) {
        ...
        params.relativeFilePath = relativeFilePath;
        params.pageUrl = window.location.href;
        Internal.callNative("File", "getFileSize", params, 'get_file_size');
    },
    ...
    app_check_file_exist:function(fileName, relativeFilePath) {
        ...
        params.relativeFilePath = relativeFilePath;
        params.pageUrl = window.location.href;
        Internal.callNative("File", "checkFileExist", params, 'check_file_exist');
    },
    ...
    app_make_dir:function(dirName,relativeDirPath) {
        ...
        Internal.callNative("File", "makeDir", params, 'make_dir');
    }
...
var Internal = {
    ...
    isAppVersionAfter62:function() {
       ...
       if (uaFlagIndex >= 0) {
            if (ua.indexOf(__EB64_FLAG) > 0) { //6.10开始加入，直接根据UA判断参数encode方式
                __IS_BASE64_ENCODE_VERSION = true;
            }  
            else {
...
var CtripMap = {
 /**
    ...
    app_locate:function(timeout, isNeedCtripCity, isForceLocate, sequenceId) {
        ...
        params.sequenceId = sequenceId;
        Internal.callNative("Locate", "locate", params, 'locate')
    },
    ...
    app_stop_locate:function(sequenceId) {
        ...
        Internal.callNative("Locate", "stopLocate", params, 'stop_locate')
    },
    ...
    app_show_map:function(latitude, longitude, title, subtitle) {
        ...
        Internal.callNative("Locate", "showMap",params, 'show_map');
    },
    ...
    app_show_map_with_POI_list:function(poiList) {
        ...
        Internal.callNative("Locate", "showMapWithPOIList",params, 'show_map_with_POI_list');
    },
       ...
       //返回数据
        var json_obj = {
            ...
            param:{                         //param字段没有的时候，代表无ctripcity缓存                   
                    "CachedLatitude":31.27796264, //V6.6加入
                    "CachedLongitude":120.9436791,//V6.6加入
                    "CountryName":"中国",       //所在国家
                    "ProvinceName":"江苏",      //所在省份
                    "CityEntities":[            //城市名列表，城市等级从低到高，先是县级市，然后是地级市，使用者应按列表顺序匹配，匹配到即结束
                        {"CityName":"昆山","CityID":100}, 
    ...
    app_get_cached_ctrip_city:function() {
        ...
        Internal.callNative("Locate", "getCachedCtripCity", null, 'get_cached_ctrip_city');
    },

    /**
     * @description 调用native的地图导航
     * @brief 调用native的地图导航
     * @param {double} fromLatitude 出发点纬度
     * @param {double} fromLongitude 出发点经度
     * @param {String} fromAddressTitle 出发点地址信息，选填
     * @param {double} toLatitude 到达点纬度
     * @param {double} toLongitude 到达点经度     
     * @param {String} toAddressTitle 到达点地址信息，选填
     * @param {double} mapType 地图类型 定义为： AppleMap(仅iOS有效)/GoogleMap/AMap(高德地图)/BaiduMap
     * @method app_map_navigation
     * @author jimzhao
     * @since v6.0
     * @example
     *
       //调用
        CtripMap.app_map_navigation(31.2779626, 120.943679, "昆山市区", 31.2061665, 121.4713538, "上海市区", BaiduMap)

     */
    app_map_navigation:function(fromLatitude, fromLongitude, fromAddressTitle, toLatitude, toLongitude, toAddressTitle, mapType) {
        var params = {};
        params.fromLatitude = fromLatitude;
        params.fromLongitude = fromLongitude;
        params.fromAddressTitle = fromAddressTitle;
        params.toLatitude = toLatitude;
        params.toLongitude = toLongitude;
        params.toAddressTitle = toAddressTitle;
        params.mapType = mapType;
        Internal.callNative("Locate", "mapNavigation", params, 'map_navigation');
    }
};

/**
 * @class CtripNetwork
 * @description Hybrid 网络相关功能
 * @brief Hybrid 网络相关功能
 */
var CtripNetwork = {
    /**
     * @description 通过 SOTP(TCP) 发 HTTP(S) 请求
     * @brief HTTP 通过 SOTP(TCP) 发 HTTP(S) 请求
     * @param {String} url 请求url，如"http://baidu.com",
     * @param {String} method GET/POST
     * @param {JSON} header request header
     * @param {String} body request body
     * @param {String} sequenceId 用来唯一标识一次网络请求
     * @method app_sotp_send_http_requst
     * @since v6.13
     * @author wei_l@Ctrip.com
     * @callback tagname="sotp_send_http_requst"
     * @example
     *
        CtripUtil.app_sotp_send_http_requst("http://baidu.com", "GET", header, body, sequenceID); 

        //调用完成，H5页面会收到如下返回数据
         var json_obj =
         {
            tagname:"sotp_send_http_requst",
            error_code:1,//错误才返回这个字段，有error_code 时 param 中只返回 sequenceID
            param:{
                sequenceId:"1345467783",//用来唯一标识一次网络请求
                status:200,//状态码
                response_header:header,//返回的头部信息，JSON
                body:body,//返回的body，String
            },
        },

        app.callback(json_obj);
    */
    app_sotp_send_http_requst:function(url, method, header, body, sequenceId) {
        var UserAgent = "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/47.0.2526.111 Safari/537.36";
        if (!header) {
            header = {};
        };
        ...
        Internal.callNative("Network", "sotpSendHttpRequest", params, 'sotp_send_http_requst')
    },
};
...
var CtripPage = {
    ...
    app_set_page_name:function(pageName) {
        ...
        Internal.callNative("Page", "setPageName", params, "set_page_name");
    },
   ...
   /**
     ...
     * @param {String} callbackString 离开H5页面，需要传递给上一个H5页面的数据，上一个H5页面在web_view_did_appear回调里面将会收到该数据, V6.5开始支持
     ...
     */
    app_back_to_page:function(pageName, callbackString) {
        if (!Internal.isSupportAPIWithVersion("5.8")) {
            return;
        }
        ...
        Internal.callNative("Page", "backToPage", params, "back_to_page");
    },
     ...
     * @param {JSON} meta 显示loading页面的配置信息，V6.10开始支持 tipsMessage 字段
     * @author jimzhao
     * @since v5.9
     * @example
     *
     * 
        CtripPage.app_show_loading_page({tipsMessage:"小贴士测试，小贴士示例代码。"});

     */
    app_show_loading_page:function(meta) {
        if (!Internal.isSupportAPIWithVersion("5.9")) {
            return;
        }
        ...
        Internal.callNative("Page", "showLoadingPage", params, "show_loading_page");
    },
    ...
    app_hide_loading_page:function() {
        ...
        Internal.callNative("Page", "hideLoadingPage", null, "hide_loading_page");
    },


    /**
     * @description 打开/关闭app的拖动手势，默认是打开的
     * @brief 打开/关闭app的拖动手势
    ...
    app_reload_current_page:function() {
        ...
        Internal.callNative("Page", "reloadCurrentPage", null, "reload_current_page");
    }
 ...
 */
 var CtripPay = {
    ...
    app_check_pay_app_install_status:function() {
        ...
        Internal.callNative("Pay","checkPayAppInstallStatus",null,'check_pay_app_install_status');
    },
    ...
    app_open_pay_app_by_url:function(payAppName, payMeta, successRelativeURL, detailRelativeURL) {
        ...
        Internal.callNative("Pay","openPayAppByURL",params,'open_pay_app_by_url');
    },
    ...
    **/
    app_call_pay: function(paymentParam) {
        ...
        Internal.callNative("Pay","callPay", paymentParam, "call_pay");
    }
...
var CtripPipe = {
     ...
     * @param {String} sequenceId 发送服务的序列号，随机生存即可,取消该请求的时候需要
     * @since v5.4
     * @author jimzhao
     * @example 
    ...
    app_send_HTTP_pipe_request:function(baseURL, path, method, header, parameters, isIgnoreHTTPSCertification, sequenceId) {
        ...
        Internal.callNative("Pipe", "sendHTTPPipeRequest", params, 'send_http_pipe_request');
    },
     ...
     * @param {String} sequenceId 发送服务的序列号，调用app_send_HTTP_pipe_request传入的sequenceId
     * @since v5.4
     * @author jimzhao
     * @example 
    ...
    app_abort_HTTP_pipe_request:function(sequenceId) {
        ...
        var params = {};
        params.sequenceId = sequenceId;
        Internal.callNative("Pipe", "abortHTTPRequest", params, 'abort_http_pipe_request');
    },
    ...
    app_send_H5_pipe_request:function(serviceCode,header,data, sequenceId, pipeType) {
        ...
        Internal.callNative("Pipe", "sendH5PipeRequest", params, 'send_h5_pipe_request');
    }
};
...
var CtripShare = {
    ...
    app_call_system_share:function(imageRelativePath, text, title, linkUrl) {
        ...
        Internal.callNative("Util", "callSystemShare", params, "call_system_share");
    },
    ...
    app_call_custom_share:function(dataList, businessCode, meta) {
        ...
        Internal.callNative("Share", "callCustomShare", params, "call_custom_share");
    },
    ...
    app_call_one_share:function(shareType, imageUrl, title, text, linkUrl, businessCode, meta) {
        ...
        Internal.callNative("Share", "callOneShare", params, "call_one_share");
    }
...
var CtripUser = {
    ...
    app_member_login:function(isShowNonMemberLogin) {
        ...
        Internal.callNative("User", "memberLogin", params, 'member_login');
    },
    ...
    app_finished_register:function(userInfoJson) {
        ...
        Internal.callNative("User", "finishedRegister", params, "finished_register");
    },
    ...
    app_finished_login:function(userInfoJson) {
        ...
        Internal.callNative("User", "finishedLogin", params, "finished_login");
    },

    /**
     * @description 用户登出，删除用户本地登录态
     * @brief 用户登出，删除用户本地登录态
     * @method app_user_logout
     * @since v6.6
     * @author jimzhao
     * @example

        CtripUser.app_user_logout();
    ...
    app_user_logout:function() {
        ...
        Internal.callNative("User", "userLogout", null, "user_logout");
    }
...
var CtripUtil = {
     ...
     * @example
         ...
         var json_obj =
         {
            ...
            param:{
                ...
                isJailBreak:true,//设备是否越狱,since 6.2
                userInfo={USERINFO},//USERINFO内部结构参考CtripUser.app_member_login();
                isUseSOTPSendHTTPRequest:true,//是否使用SOTP(TCP)发HTTP(S)服务，since 6.13
            }
         }
         app.callback(json_obj);
     */
    ...
    app_call_phone:function(phone, pageId, businessCode) {  
        ...
        Internal.callNative("Util", "callPhone", params, "call_phone")
    },
    ...
    app_back_to_last_page:function(callbackString, isDeleteH5Page) {
        ...
        Internal.callNative("Util", "backToLast", params, "back_to_last_page");
    },
     ...
     * @param {boolean} isShowLoadingPage  @optional 开启新的webview的时候，是否加载app的loading v6.3，该参数废弃，不再work。 V6.4开始，重新work

        关于loading页面的说明：

        1. 从App 首页，进入的Hybrid页面，默认显示native的loading，页面载入完成后，Lizard框架负责关闭该loading；

        2. 在Hybrid页面，通过app_open_url打开新的页面(不区分local/online)，支持isShowLoadingPage参数(默认为false)，如果参数为true，native显示loading，Lizard框架负责关闭该loading；
        
        3. 在Hybrid页面内部，需要显示loading的时候，Lizard框架包装，让BU直接调用native的loading，现有H5的情感化设计loading不再需要；
        
        4. 从App首页，进入的广告页面，默认显示native的loading，页面载入完成之后，native负责关闭该loading；
        
        5. Native提供的showLoading/hideLoading API可以重复调用；

     * @param {JSON} meta, 页面跳转的一些配置参数,现在支持:<br/>

        isHideNavBar字段，boolean类型，v6.2加入;<br/>

        isHideLoadingViewForOnlinePage，v6.3加入，打开online H5页面，默认显示加载页面，该属性可以关闭; <br/>

        isDisablePushAnimation, v6.5加入, 打开新的webview的时候，是否关闭动画; 注：iOS里面2个页面切换动画同时出现的时候，容易crash，系统级别的问题;<br/>
...
        params.targetMode = targetMode;
        ...
        if (Internal.isInApp) {
            Internal.callNative("Util", "openUrl", params, "open_url");
        } 
        else {
    ...
    app_cross_package_href:function(path, param) {
        ...
        Internal.callNative("Util", "crossPackageJumpUrl", params, "cross_package_href");
    },

    /**
     * @description 检查当前App网络状况
     * @brief 检查当前App网络状况，网络质量 networkQuality 6.13开始支持
     * @since v5.2
     ...
     * @example 
     ...
     var json_obj = 
     {
        ...
        param = {
            ...
            networkQuality:"Invalid", //6.13加入 "Invalid" 无效/ "Poor" 差 /"ModeRate" 2G/"Good" 好/"Excellent" 非常好
        }
     }
     app.callback(json_obj);
    ...
    /**
     * @description 检查一个App是否安装
     * @brief  检查一个App是否安装
     * @param {String} openUrl 尝试打开的URL，iOS使用
     * @param {String} packageName app的包名，android使用
     * @param {String} urlList 尝试打开的URL列表，iOS使用, V6.7加入
     * @param {String} packageList app的包名列表，android使用, V6.7加入
     * @method app_check_app_install_status
     * @since v5.2
     * @author jimzhao
     * @example 

     常用Android packageID/iOS URL Schema
     百度地图-----packageID: com.baidu.BaiduMap               URLSchema: baidumap://
     谷歌地图-----packageID: com.google.android.apps.maps     URLSchema: comgooglemaps://
     高德地图-----packageID: com.autonavi.minimap             URLSchema: iosamap://
     微信   -----packageID: com.tencent.mm                   URLSchema: weixin://
     QQ    -----packageID: com.tencent.mobileqq              URLSchema: qq://
     支付宝-----packageID: com.eg.android.AlipayGphone        URLSchema: alipay://
     支付宝快捷支付-----packageID: com.alipay.android.app
    ...
    app_check_app_install_status:function(openUrl, packageName) {
        ...
        Internal.callNative("Util", "checkAppInstallStatus", params, "check_app_install_status");
    },

    /**
     * @description 检查一组App是否安装
     * @brief  检查一组App是否安装
     * @param {String} urlSchemaList 尝试打开的URL列表，iOS使用
     * @param {String} packageIdList app的包名列表，android使用
     * @method app_check_apps_install_status
     * @since v6.7
     * @author jimzhao
     * @example 
     ...
     CtripUtil.app_check_apps_install_status(["ctrip://wireless", "weixin://xx"], ["com.ctrip.view", "com.tencent.mm"]);
     //调用完成后，H5页面会收到如下回调数据
     var json_obj = 
     {
        tagname:"check_apps_install_status",
        param: {
            "ctrip://wireless":true,//布尔值返回是否有安装 
            "weixin://xx":true,
            "com.ctrip.view":false,
            "com.tencent.mm":false
        }
     }
     app.callback(json_obj);
     */
    app_check_apps_install_status:function(urlSchemaList, packageIdList) {
        var params = {};
        params.urlSchemaList = urlSchemaList;
        params.packageIdList = packageIdList;
        Internal.callNative("Util", "checkAppsInstallStatus", params, "check_apps_install_status");
    },
    ...
    app_refresh_native_page:function(pageName, jsonStr) {
        ...
        Internal.callNative("Util", "refreshNativePage", params, "refresh_native_page");
    },
    ...
    app_copy_string_to_clipboard:function(toCopyStr) {
        ...
        Internal.callNative("Util", "copyToClipboard", params, "copy_string_to_clipboard");
    },

    /**
     * @description 检测页面劫持并替换为 HTTPS
     * @brief 检测页面劫持并替换为 HTTPS
     * @param {String} regEx 检测劫持的正则表达式
     * @method app_check_hijack
     * @since v5.3
     * @author wei_l@Ctrip.com
     * @example CtripUtil.app_check_hijack("/((100msh|cnzz|10086|gx10010)\\.(com|cn))|(\\/baseline\\/scg.js)|(\\/tlbsserver\\/jsreq[\\/?])/");

     */
    app_check_hijack:function(regEx) {
        if (!Internal.isSupportAPIWithVersion("6.13")) {
            return;
        }
        var params = {};
        ...
        Internal.callNative("Util", "checkHijack", params, "check_hijack");
    },
    ...
    app_read_copied_string_from_clipboard:function() {
        ...
        Internal.callNative("Util", "readCopiedStringFromClipboard", null, "read_copied_string_from_clipboard");
    },
    ...
    app_download_data:function(download_url, suffix, isIgnoreHttpsCertification) {
        ...
        Internal.callNative("Util", "downloadData",params,"download_data");
    },
    ...
    app_open_other_app:function(packageId, jsonParam, url) {
        ...
        params.jsonParam = jsonParam;
        params.url = url;
        Internal.callNative("Util", "openOtherApp", params, "open_other_app");
    },
    ...
    app_log:function(log, result) {
        ...
        Internal.callNative("Util", "h5Log", params, "log");
    },
     ...
     * @param {JSON} meta 图片选取相关配置信息，5.8新增，5.8版本开始支持1个key， canEditSinglePhoto:单选能否编辑, cameraMaskImageUrl,拍照片支持的蒙层图片URL，V6.6开始支持
    ...
    app_choose_photo:function(maxFileSize, maxPhotoCount, meta) {
        ...
        Internal.callNative("Util", "choosePhoto", params, "choose_photo");
    },
    ...
    app_save_photo:function(photoUrl, photoBase64String, imageName) {
        ...
        Internal.callNative("Util", "savePhoto", params, "save_photo");
    },

       /**
     * @description 发送快捷方式到桌面
     * @brief  发送快捷方式到桌面
     * @param {String} url ctrip://协议  参考：http://conf.ctripcorp.com/pages/viewpage.action?pageId=57518232
     * @param {String} shortcutName 快捷方式的名字
     * @param {String} imageName 快捷方式图片的名字
     * @method app_add_shortcut
     * @callback add_shortcut
     * @since v6.4
     * @author ruiw
     * @example
        
       //发送用车图标到桌面
       CtripUtil.app_add_shortcut("ctrip://wireless/h5?url=Y2FyL2luZGV4Lmh0bWw=&type=1", "用车","common_ic_launcher");
     
     */
    app_add_shortcut:function(url, shortcutName, imageName) {
        ...
        params.imageName = imageName;
        Internal.callNative("Util", "addShortcut", params, "add_shortcut");
    },
    ...
    app_h5_page_finish_loading:function() {
        ...
        Internal.callNative("Util", "h5PageFinishLoading", null, "h5_page_finish_loading");
    },

    /**
     * @description 使用native的图片浏览器浏览图片, 图片浏览有2种模式，a.缩略图模式，点击缩略图之后，进入大图模式；b.直接进入大图模式，此时需要传入选中的图片index
     * @brief 使用native的图片浏览器浏览图片
     * @method app_show_photo_broswer
     * @param photoList 图片列表，JSON数组
     * @param shareDataList 在大图页面，分享的时候，分享的内容,可以定制分享到各个平台的内容，参数格式参考CtripShare.app_call_custom_share(dataList)，其中分享的图片地址不需要传递;
     * @param showPhotoIndex 直接进入大图模式(isThumbnailModel=false)的时候生效，表示当前显示的图片，在图片列表中的index
     * @param meta, JSON对象，支持1.isThumbnailModel 是否是进入缩略图图模式，进入缩略图模式的时候，屏幕中显示的是当前photos里面所有的图片，showPhotoIndex无效，2.businessCode:业务code，用于埋点统计
     * @since v6.6
     * @author jimzhao
     * @example
       ...
       var photoList = [];
       var aPhoto = {};
       aPhoto.imageUrl = "http://images3.c-ctrip.com/hx/201503/jjx580x145.jpg";
       aPhoto.imageThumbnailUrl = "http://images3.c-ctrip.com/rk/201504/0yc33.jpg";//可选，thumbNail模式下，建议设置
       aPhoto.category = "广告图片"; //可选，有category的时候，图片浏览器底部会有筛选栏
       aPhoto.imageTitle = "来自酒店的图片";
       aPhoto.imageDescription = "本次酒店的广告活动主要有blablabla。。。。。";
       photoList.push(aPhoto);

       var bPhoto = {};
       bPhoto.imageUrl = "http://img1.gtimg.com/12/1245/124582/12458207_980x1200_0.jpg";
       bPhoto.imageThumbnailUrl = "http://img1.gtimg.com/ninja/0/ninja143022328729027.jpg"; //可选，thumbNail模式下，建议设置
       bPhoto.category = "腾讯的图片"; //可选，有category的时候，图片浏览器底部会有筛选栏
       bPhoto.imageTitle = "来自腾讯的新闻图片";
       bPhoto.imageDescription = "腾讯新闻：巴格马蒂河又有“小恒河”之称，当地的印度教徒笃信死者的遗体焚化后，把骨灰撒入河里，就会随河水流转圣河，登至极乐。";
       photoList.push(bPhoto);
       ...
       var shareDataList = [
        {
            ...
            text:"这本书的简介大概是这样",
            linkUrl:"http://csdn.net"
            imageUrl:"xxxx"//说明，此处imageUrl不需要设置，会默认使用当前图片的URL
            shareType:"Default",
        }];
        var meta = {};
        meta.isThumbnailModel = true;
        meta.businessCode = "ticket_broswer_001";
       CtripUtil.app_show_photo_broswer(photoList, shareDataList, 0, true);

     */
    app_show_photo_broswer:function(photoList, shareDataList, showPhotoIndex, meta) {
        if (!Internal.isSupportAPIWithVersion("6.5")) {
            return;
        }
        var params = {};
        params.photoList = photoList;
        params.shareDataList = shareDataList;
        params.showPhotoIndex = showPhotoIndex;
        params.meta = meta;

        Internal.callNative("Util", "showPhotoBroswer", params, "show_photo_broswer");
    },

    /**
     * @description 扫描二维码
     * @brief 扫描二维码
     * @method app_scan_qrcode
     * @callback scan_qrcode
     * @since v6.6
     * @author jimzhao
     * @example
        
      //调用  
     CtripUtil.app_scan_qrcode();
    ...
    app_scan_qrcode:function() {
        if (!Internal.isSupportAPIWithVersion("6.6")) {
            return;
        }

        Internal.callNative("Util", "scanQRCode", null, "scan_qrcode");
    },

    /**
     * @description 设置屏幕亮度
     * @brief 设置屏幕亮度
     * @method app_set_screen_brightness
     * @param brightness {float} 屏幕亮度值（brightness > 0 && brightness <= 1，否则不会起作用）
     * @callback set_screen_brightness
     * @since v6.11
     * @author wei_l
     * @example
        
      //调用  
     CtripUtil.app_set_screen_brightness(0.8);

     //调用完成之后，返回的数据格式
       var json_obj =
        {
            tagname:"set_screen_brightness"
        }

        app.callback(json_obj);
     */
    app_set_screen_brightness:function(brightness) {
        ...
        Internal.callNative("Util", "setScreenBrightness", params, "set_screen_brightness");
    },

    /**
     * @description 获取屏幕亮度
     * @brief 获取屏幕亮度
     * @method app_get_screen_brightness
     * @callback get_screen_brightness
     * @since v6.11
     * @author wei_l
     * @example
        
      //调用  
     CtripUtil.app_get_screen_brightness();

     //调用完成之后，返回的数据格式
       var json_obj =
        {
            tagname:"get_screen_brightness",
    ...
    app_get_screen_brightness:function() {
        ...
        Internal.callNative("Util", "getScreenBrightness", null, "get_screen_brightness");
    },
    ...
    /**
     * @description 获取是否打开推送开关
     * @brief 获取是否打开推送开关
     * @method app_is_remote_notification_enabled
     * @callback is_remote_notification_enabled
     * @since v6.15
     * @author wei_l
     * @example
        
      //调用  
     CtripUtil.app_is_remote_notification_enabled();

     //调用完成之后，返回的数据格式
       var json_obj =
        {
             "tagname" : "is_remote_notification_enabled",
              "param" : {
                "is_remote_notification_enabled" : true
              }
        }
    ...
    app_is_remote_notification_enabled:function() {
        ...
        Internal.callNative("Util", "isRemoteNotificationEnabled", null, "is_remote_notification_enabled");
    },
};
