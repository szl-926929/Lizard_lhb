...
(function () {
  ...
  function initLizardConfig() {
    ...
    for (var i = 0; i < scripts.length; i++) {
      ...
      if (src && reg.test(src)) {
        ...
        try{
          if(window.lizardTestDomian){
            Lizard.dir = Lizard.dir.replace(Lizard.dir.substr(0, Lizard.dir.lastIndexOf('/code/lizard')),window.lizardTestDomian);
          }
        }catch(e){}
        if (!Lizard.notpackaged) {
  ...
  function initAppByPackaged(pageConfig) {
    ...
    //try{
    //  comboDomian = window.lizardTestDomian ? window.lizardTestDomian : comboDomian;
    //}catch(e){}
    var asynComboModules = [];
    if (Lizard.config.isMultipage) {
      //asynComboModules = Lizard.pdConfig;
      asynComboModules.push(isUseBeta ? "/code/lizard/2.2/beta/lizard.multi.js":"/code/lizard/2.2/web/lizard.multi.js");
      if (Lizard.app.vendor.is('CTRIP')) {
        asynComboModules.push(isUseBeta ? "/code/lizard/2.2/beta/lizard.hybrid.multi.js":"/code/lizard/2.2/web/lizard.hybrid.multi.js");
      } else {
        asynComboModules.push(isUseBeta ? "/code/lizard/2.2/beta/lizard.web.multi.js" :"/code/lizard/2.2/web/lizard.web.multi.js");
      }
      ...
      if (Lizard.notpackaged || Lizard.isHybrid || window.isUserHybridSeed) {
        ...
        asynComboModules.push(isUseBeta ? "/code/lizard/2.2/beta/lizard.core.js" :"/code/lizard/2.2/web/lizard.core.js");
        if (!Lizard.app.vendor.is('CTRIP') || Lizard.app.code.is('GS') || Lizard.app.code.is('DIS')) {
          asynComboModules.push(isUseBeta ? "/code/lizard/2.2/beta/lizard.web.js" :"/code/lizard/2.2/web/lizard.web.js");
        }
        if (Lizard.config.plainloading) {
          //asynComboModules.push("/code/lizard/2.2/web/ui/ui.loading.layer.js");        
        }
        if(window.isLizardDebug){
          if(isUseBeta){
            loadScript(comboDomian + "/code/lizard/2.2/beta/lizard.core.src.js", function(){
              loadScript(comboDomian + "/code/lizard/2.2/beta/lizard.web.src.js", initApp);
            });
          }else{
            loadScript(comboDomian + "/code/lizard/2.2/web/lizard.core.src.js", function(){
              loadScript(comboDomian + "/code/lizard/2.2/web/lizard.web.src.js", initApp);
            });
          }
        }else{
          var lastModified;
