define(['cPlugins', 'cCoreInherit', Lizard.isHybrid ? 'cHybridApp' : (Lizard.app.code.is('MASTER') || Lizard.app.code.is('YOUTH') ? 'cWebViewApp' : 'cWebApp'), 'cPadExtend', 'cGuiderService','cUtilCommon'], function (plugins, cCoreInherit, APP, cPadExtend, Guider,cUtilCommon) {
  ...
  function _createLizardIns() {
    ...
    if ((!Lizard.config.isBeforeViewFinishedLoadInitApp && !Lizard.config.isViewFinishedLoadInitApp) || window.name) {
