  ...
  var validators = {
    ...
    isTraditional: function (text) { //判断是否包含繁体字
      cperformance.log({
        name: 'FunUsed',
        url: window.location.href,
        fun: "cUtilValidate.isTraditional"
      });
    ...
    isCharsLenWithinRange: function (value, max) {
      cperformance.log({
        name: 'FunUsed',
        url: window.location.href,
        fun: "cUtilValidate.isCharsLenWithinRange"
      });
      if (!_.isString(value)){
      	return false;
      }
