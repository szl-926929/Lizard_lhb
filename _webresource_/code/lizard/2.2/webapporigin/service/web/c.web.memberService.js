 ...
 * @version V1.0
 */
define(['cUserModel', 'cUtilValidate', 'cUtilPath', 'cCommonStore','cUtilCommon','cLocalStore','cCookieStorage','cUtilPerformance'],
  function (UserModel, cUtilValidate,cUtilPath, CommonStore,cUtilCommmon,cLocalStore,cCookieStorage,cperformance) {
    "use strict";
  ...
  var Member = {
    ...
    autoLogin: function (opt) {
      ...
      app_finished_login: function () {
        ...
        //  name: 'FunUsed',
        //  url: window.location.href,
        //  fun: "cMemberService.app_finished_login"
        //});
        return false;
      }
    };
