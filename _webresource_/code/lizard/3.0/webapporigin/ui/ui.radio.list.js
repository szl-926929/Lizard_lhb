define(['UILayer', getAppUITemplatePath('ui.radio.list'), 'UIScroll'], function (UILayer, template, UIScroll) {
  ...
  return _.inherit(UILayer, {
    ...
    clickAction: function (e) {
      ...
      this.setIndex(i);
      if (this.onClick){
      	this.onClick.call(this, this.getSelected(), i, e);
      }
    ...
    _position: function () {
      ...
      if (this.itemNum - index < this.displayNum){
      	index = this.itemNum - this.displayNum;
      }
    ...
    addEvent: function ($super) {
      ...
      this.on('onShow', function () {
        this.initSize();
        if (this.scroll && this.scroll.destory){
        	  this.scroll.destory();
        }
