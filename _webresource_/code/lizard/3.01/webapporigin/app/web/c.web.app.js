  ...
  return cCoreInherit.Class(APP, {
    bindEvents: function ($super) {
      ...
      window.addEventListener('popstate', _.bind(function (e) {
        ...
        if ((UtilCommon.isIpod || UtilCommon.isIphone || UtilCommon.isIpad) && Lizard.app.code.is('WEIXIN') && history.length == 1) {
          return;
        }
        ...
        this.popstateTimeout = setTimeout(_.bind(function () {
          delete this.doneFlag;
          clearTimeout(this.popstateTimeout);
          delete this.popstateTimeout;
        },this), 500);
      }, this));
    },
    ...
    goTo: function (url, opt) {
      ...
      cAjax.get(geturl, opt ? opt.data : {}, function (html) {
        ...
        this.showWarning404(function () {
          ...
          if (this.curView) {
            Lizard.goTo(this.lastView.$el.getAttribute('page-url'), {pushState: false});
          } else {
            Lizard.goBack();
          }
        }}}});
