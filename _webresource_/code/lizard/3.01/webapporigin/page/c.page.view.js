 ...
 * })
 */
define([((Lizard.app.vendor.is('CTRIP') || Lizard.isHybrid) && !Lizard.app.code.is('WE'))? 'cHybridHeader' : 'UIHeader', 'cGuiderService'],
  function (Header, Guider) {
    "use strict";
    /**
     * 根元素,jQuery对象
  ...
  PageView.prototype = {
     ...
     */
    show: function () {
      if( this.pageinstance&&typeof(this.pageinstance.onShow)==="function" ){
    ...
    hide: function () {
      this.hideLoading();
      if( this.pageinstance&&typeof(this.pageinstance.onHide)==="function" ){
